...
if ($res) $stats['total_orders'] = $res->fetch_assoc()['count'];
...
$res = $conn->query("
    ...
    LIMIT 2
");
if ($res) $stats['recent_orders'] = $res->fetch_all(MYSQLI_ASSOC);

// Get new users
$res = $conn->query("SELECT fullname FROM users ORDER BY created_at DESC LIMIT 2");
if ($res) $stats['new_users'] = $res->fetch_all(MYSQLI_ASSOC);
...
<html lang="en">
  ...
  <body>
        ...
        <div class="overview">
          ...
          <div class="boxes">
            <div class="box box1">
              ...
              <span class="number"><?= $stats['total_users'] ?></span>
            </div>
            <div class="box box2">
    ...
    <script>
      ...
      // Notification and message icons functionality
      document.querySelector('.uil-bell').addEventListener('click', () => {
        alert('You have new notifications');
      });
      
      document.querySelector('.uil-envelope').addEventListener('click', () => {
