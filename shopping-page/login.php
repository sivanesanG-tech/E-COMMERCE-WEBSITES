...
if (isset($_POST['register'])) {
    ...
    if ($check_result->num_rows > 0) {
        ...
        $query = "INSERT INTO users (fullname, username, email, phone, gender, location, password, created_at) VALUES ('$fullname', '$username', '$email', '$phone', '$gender', '$location', '$password', '$created_at')";
        if ($conn->query($query)) {
...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $_SESSION['username'] = $row['username']; // Store updated username in session
            ...
            echo "<script>setTimeout(function(){ window.location.href='../shopping-page/shopping.php'; }, 1500);</script>"; // Corrected path
        } else {
...
<head>
    ...
    <style>
        body {
            ...
            text-align: center;
            background: url('wp11711995-dress-shop-wallpapers.jpg') no-repeat center center fixed;
    ...
    <div class="container">
        ...
        <div id="registerBox" class="form-box <?php echo isset($_SESSION['just_registered']) ? 'active' : ''; ?>">
            ...
            <form method="POST">
                ...
                <input type="text" name="location" required placeholder="Location"><br> <!-- Added location input -->
                <div class="password-wrapper">
